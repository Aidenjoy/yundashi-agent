...
/** Why a known Yundashi Agent command has no desktop UI surface. */
...
const DESKTOP_COMMAND_SPECS: readonly DesktopCommandSpec[] = [
  ...
  { name: '/profile', description: 'Switch the active Yundashi Agent profile', surface: action('profile') },
  ...
  { name: '/version', description: 'Show Yundashi Agent version', surface: exec() },
 ...
 * Yundashi Agent' built-in slash commands — i.e. skill commands (`/gif-search`,
