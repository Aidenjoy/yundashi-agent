...
export const en: Translations = {
  ...
  boot: {
    ready: 'Yundashi Agent Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      configureGateway: 'Configure a remote gateway in Settings',
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Yundashi Agent settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingHermesDesktop: 'Starting Yundashi Agent Desktop…'
    },
    errors: {
      backgroundExited: 'Yundashi Agent background process exited.',
      backgroundExitedDuringStartup: 'Yundashi Agent background process exited during startup.',
    ...
    failure: {
      title: "Yundashi Agent couldn't start",
      description:
      ...
      configureRemoteGateway: 'Configure remote gateway',
      openLogs: 'Open logs',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Yundashi Agent backend is older than this desktop build and may not work correctly. Update to align them.',
    updateHermes: 'Update Yundashi Agent',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Yundashi Agent Desktop.',
    ...
    native: {
      ...
      inputBody: 'Yundashi Agent is waiting for your response.',
      turnDoneTitle: 'Yundashi Agent finished',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Yundashi Agent defaults?',
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Yundashi Agent is in the background.',
      kinds: {
        approval: {
        ...
        input: {
          label: 'Input needed',
          description: 'Yundashi Agent asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Yundashi Agent was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    searchPlaceholder: {
      about: 'About Yundashi Agent Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Yundashi Agent follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Yundashi Agent is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Yundashi Agent, then come back here.',
        on: 'On',
        off: 'Off',
        scaleTitle: 'Size',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Yundashi Agent checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Yundashi Agent configuration...',
    ...
    gateway: {
      ...
      intro:
        'Yundashi Agent Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Yundashi Agent backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Yundashi Agent backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Yundashi Agent backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      ...
      restartingMessage: 'Yundashi Agent Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Yundashi Agent ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Yundashi Agent runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Yundashi Agent to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Yundashi Agent to generate pets.',
      backgroundHint: 'You can close this — Yundashi Agent will notify you when it’s done.',
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Yundashi Agent desktop' },
    ...
    hermesActiveSessions: (version, count) => `Yundashi Agent ${version} · Active sessions ${count}`,
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Yundashi Agent environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Yundashi Agent will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Yundashi Agent...',
    placeholderReconnecting: 'Reconnecting to Yundashi Agent…',
    placeholderFollowUp: 'Send follow-up',
    newSessionPlaceholders: [
      'What are we building?',
      'Give Yundashi Agent a task',
      "What's on your mind?",
    ...
    attachUrlDesc: 'Yundashi Agent will fetch the page and include it as context for this turn.',
  ...
  updates: {
    stages: {
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Yundashi Agent…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Yundashi Agent…',
    ...
    unsupportedMessage: 'This version of Yundashi Agent can’t update itself from inside the app.',
    ...
    availableBody: 'A new version of Yundashi Agent is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Yundashi Agent backend is ready to install.',
    availableBodyNoChangelog: 'A newer version is ready. Release notes aren’t available for this install type.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Yundashi Agent from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Yundashi Agent will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Yundashi Agent desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Yundashi Agent updater takes over in its own window and reopens Yundashi Agent automatically when it’s done. Please don’t reopen Yundashi Agent yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Yundashi Agent reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Yundashi Agent reopens on its own.',
  ...
  install: {
    ...
    oneTimeTitle: 'Yundashi Agent needs a one-time install',
    ...
    settingUpTitle: 'Setting up Yundashi Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Yundashi Agent CLI or desktop instance is running. Stop any running Yundashi Agent instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Yundashi Agent installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Yundashi Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Yundashi Agent is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Yundashi Agent…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Yundashi Agent',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Yundashi Agent at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Yundashi Agent connects automatically',
      loopback: 'Opens your browser to sign in — Yundashi Agent connects automatically',
    ...
    authorizeThere: 'Authorize Yundashi Agent there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Yundashi Agent there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Yundashi Agent inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Yundashi Agent will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Yundashi Agent is restarting...',
      askRestart: 'Ask Yundashi Agent to restart the server',
      lookingRestart: taskId => `Yundashi Agent is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Yundashi Agent is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Yundashi Agent finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Yundashi Agent could not restart the server.',
      stillWorking:
        'Yundashi Agent is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Yundashi Agent is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Yundashi Agent gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.hermes/config.yaml). Yundashi Agent won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Yundashi Agent needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Yundashi Agent needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Yundashi Agent Desktop to use Save Image.',
    restartToSaveImages: 'Restart Yundashi Agent Desktop to save images',
