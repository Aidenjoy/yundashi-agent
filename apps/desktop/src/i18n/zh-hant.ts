...
export const zhHant = defineLocale({
  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        title: '寵物',
        intro: '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 Yundashi Agent 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
  ...
  updates: {
    ...
    applyingBody: 'Yundashi Agent 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 Yundashi Agent。更新期間請勿自行重新開啟 Yundashi Agent。',
