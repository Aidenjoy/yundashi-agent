...
export const zh: Translations = {
  ...
  settings: {
    ...
    appearance: {
      ...
      pet: {
        title: '宠物',
        intro: '领养一只悬浮在应用上的 petdex 动画宠物，它会根据 Yundashi Agent 的状态做出反应——工具执行时奔跑、成功时欢呼、出错时沮丧。',
  ...
  updates: {
    ...
    guiSkewBody: '后端已更新，但此桌面应用包未更改。请更新或重新安装 Yundashi Agent 桌面应用（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '复制',
    copied: '已复制',
    done: '完成',
    applyingBody: 'Yundashi Agent 更新器会在自己的窗口中接管，并在完成后自动重新打开 Yundashi Agent。更新期间请不要自行重新打开 Yundashi Agent。',
