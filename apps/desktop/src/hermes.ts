...
export class HermesGateway extends JsonRpcGatewayClient {
  constructor() {
    super({
      closedErrorMessage: 'Yundashi Agent gateway connection closed',
      connectErrorMessage: 'Could not connect to Yundashi Agent gateway',
      createRequestId: nextId => nextId,
      notConnectedErrorMessage: 'Yundashi Agent gateway is not connected',
