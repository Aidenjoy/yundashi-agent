 ...
 *  (CLI-managed) providers, which Yundashi Agent can't clear via the API — the user
 *  sees exactly what runs instead of Yundashi Agent silently deleting their creds. */
